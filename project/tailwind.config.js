  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-card': 'linear-gradient(135deg, rgba(139, 92, 246, 0.1) 0%, rgba(30, 41, 59, 0.2) 100%)',
        'gradient-button': 'linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%)',
        'gradient-hero': 'linear-gradient(135deg, #1e1b4b 0%, #312e81 25%, #1e1b4b 50%, #0f172a 100%)',
      },
      backdropBlur: {
        xs: '2px',
      },
